...
.then ( data => {
 ...
 eventosPasados= todosEvents.filter ( events => events.date < data.currentDate)
...
//  //imprimir
 ...
 inputSearch.addEventListener ( 'input', () => {
   const busqueda = filterTittle ( eventosPasados, inputSearch.value)
